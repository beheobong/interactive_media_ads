...
class AndroidAdDisplayContainerCreationParams
  ...
  const AndroidAdDisplayContainerCreationParams({
    Key key,
    @required
        void Function(PlatformAdDisplayContainer container) onContainerAdded,
    ...
    @visibleForTesting PlatformViewsServiceProxy platformViewsProxy,
        ...
        super(onContainerAdded: onContainerAdded, key: key);
...
class AndroidAdDisplayContainer extends PlatformAdDisplayContainer {
  /// Constructs an [AndroidAdDisplayContainer].
  AndroidAdDisplayContainer(PlatformAdDisplayContainerCreationParams params)
    ...
    _androidParams = params is AndroidAdDisplayContainerCreationParams
        ? params
        : AndroidAdDisplayContainerCreationParams
            .fromPlatformAdDisplayContainerCreationParams(params);
    _frameLayout = _androidParams._imaProxy.newFrameLayout();
  }
  ...
  ima.FrameLayout _frameLayout;

  // Handles loading and displaying an ad.
  ima.VideoView _videoView;
  ...
  ima.VideoAdPlayer _videoAdPlayer;
  ...
  AndroidAdDisplayContainerCreationParams _androidParams;
