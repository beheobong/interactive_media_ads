...
class InteractiveMediaAdsProxy {
  ...
  const InteractiveMediaAdsProxy({
    this.newVideoProgressUpdate,
    this.newFrameLayout,
    this.newVideoView,
    this.newVideoAdPlayer,
    this.newAdsLoadedListener,
    this.newAdErrorListener,
    this.newAdEventListener,
  ...
  final VideoAdPlayer Function({
    ...
    @required
        void Function(VideoAdPlayer, VideoAdPlayerCallback) removeCallback,
  ...
  final AdsLoadedListener Function({
    @required
        void Function(AdsLoadedListener, AdsManagerLoadedEvent)
            onAdsManagerLoaded,
