...
/// scenario where the weak referenced instance was released and then r
...
class AdsLoader extends PigeonProxyApiBaseClass {
  ...
  AdsLoader.pigeon_detached({
    BinaryMessenger pigeon_binaryMessenger,
    PigeonInstanceManager pigeon_instanceManager,
  })  : __pigeon_codecAdsLoader =
            _PigeonProxyApiBaseCodec(pigeon_instanceManager),
        super(
            pigeon_binaryMessenger: pigeon_binaryMessenger,
            pigeon_instanceManager: pigeon_instanceManager);

  final _PigeonProxyApiBaseCodec __pigeon_codecAdsLoader;
  ...
  Future<void> addAdErrorListener(AdErrorListener listener) async {
    ...
    final List<Object> __pigeon_replyList =
        await __pigeon_channel.send(<Object>[this, listener]) as List<Object>;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
...
class AdsRequest extends PigeonProxyApiBaseClass {
  ...
  final _PigeonProxyApiBaseCodec __pigeon_codecAdsRequest;
  ...
  Future<void> setAdTagUrl(String adTagUrl) async {
    ...
    final List<Object> __pigeon_replyList =
        await __pigeon_channel.send(<Object>[this, adTagUrl]) as List<Object>;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
  ...
  Future<void> setContentProgressProvider(
    ...
    final List<Object> __pigeon_replyList =
        await __pigeon_channel.send(<Object>[this, provider]) as List<Object>;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
...
class AdsManager extends BaseManager {
  ...
  final _PigeonProxyApiBaseCodec __pigeon_codecAdsManager;
...
class BaseManager extends PigeonProxyApiBaseClass {
  ...
  final _PigeonProxyApiBaseCodec __pigeon_codecBaseManager;
...
class ImaSdkFactory extends PigeonProxyApiBaseClass {
  ...
  final _PigeonProxyApiBaseCodec __pigeon_codecImaSdkFactory;
...
class VideoProgressUpdate extends PigeonProxyApiBaseClass {
  ...
  final _PigeonProxyApiBaseCodec __pigeon_codecVideoProgressUpdate;
...
class FrameLayout extends ViewGroup {
  ...
  final _PigeonProxyApiBaseCodec __pigeon_codecFrameLayout;
...
class ViewGroup extends View {
  ...
  ViewGroup.pigeon_detached({
    BinaryMessenger pigeon_binaryMessenger,
    PigeonInstanceManager pigeon_instanceManager,
  })  : __pigeon_codecViewGroup =
            _PigeonProxyApiBaseCodec(pigeon_instanceManager),
        super.pigeon_detached(
            pigeon_binaryMessenger: pigeon_binaryMessenger,
            pigeon_instanceManager: pigeon_instanceManager);

  final _PigeonProxyApiBaseCodec __pigeon_codecViewGroup;
...
class VideoView extends View {
  ...
  final _PigeonProxyApiBaseCodec __pigeon_codecVideoView;
...
class MediaPlayer extends PigeonProxyApiBaseClass {
  ...
  final _PigeonProxyApiBaseCodec __pigeon_codecMediaPlayer;
...
class VideoAdPlayerCallback extends PigeonProxyApiBaseClass {
  ...
  final _PigeonProxyApiBaseCodec __pigeon_codecVideoAdPlayerCallback;
  ...
  Future<void> onAdProgress(
    ...
    final List<Object> __pigeon_replyList = await __pigeon_channel
        .send(<Object>[this, adMediaInfo, videoProgressUpdate]) as List<Object>;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
...
class VideoAdPlayer extends PigeonProxyApiBaseClass {
  ...
  final _PigeonProxyApiBaseCodec __pigeon_codecVideoAdPlayer;
  ...
  Future<void> setAdProgress(VideoProgressUpdate progress) async {
    ...
    final List<Object> __pigeon_replyList =
        await __pigeon_channel.send(<Object>[this, progress]) as List<Object>;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
...
class AdsLoadedListener extends PigeonProxyApiBaseClass {
  ...
  final _PigeonProxyApiBaseCodec __pigeon_codecAdsLoadedListener;
...
class AdErrorListener extends PigeonProxyApiBaseClass {
  ...
  final _PigeonProxyApiBaseCodec __pigeon_codecAdErrorListener;
...
class AdEventListener extends PigeonProxyApiBaseClass {
  ...
  final _PigeonProxyApiBaseCodec __pigeon_codecAdEventListener;
