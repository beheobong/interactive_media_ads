...
/// An immutable object that serves as the  class for all ProxyApis and
...
class IMAAdDisplayContainer extends NSObject {
  ...
  final _PigeonProxyApiBaseCodec __pigeon_codecIMAAdDisplayContainer;
...
class UIViewController extends NSObject {
  ...
  final _PigeonProxyApiBaseCodec __pigeon_codecUIViewController;
...
class IMAContentPlayhead extends NSObject {
  ...
  final _PigeonProxyApiBaseCodec __pigeon_codecIMAContentPlayhead;
...
class IMAAdsLoader extends NSObject {
  ...
  final _PigeonProxyApiBaseCodec __pigeon_codecIMAAdsLoader;
  ...
  Future<void> setDelegate(IMAAdsLoaderDelegate delegate) async {
    ...
    final List<Object> __pigeon_replyList =
        await __pigeon_channel.send(<Object>[this, delegate]) as List<Object>;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
...
class IMAAdsRequest extends NSObject {
  ...
  final _PigeonProxyApiBaseCodec __pigeon_codecIMAAdsRequest;
...
class IMAAdsLoaderDelegate extends NSObject {
  ...
  final _PigeonProxyApiBaseCodec __pigeon_codecIMAAdsLoaderDelegate;
...
class IMAAdsManager extends NSObject {
  ...
  final _PigeonProxyApiBaseCodec __pigeon_codecIMAAdsManager;
...
class IMAAdsManagerDelegate extends NSObject {
  ...
  final _PigeonProxyApiBaseCodec __pigeon_codecIMAAdsManagerDelegate;
...
class IMAAdsRenderingSettings extends NSObject {
  ...
  final _PigeonProxyApiBaseCodec __pigeon_codecIMAAdsRenderingSettings;
