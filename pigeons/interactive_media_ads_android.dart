...
// }
//
// /// A  class for more specialized container interfaces.
// ///
...
//   @static
//   @attached
//    final VideoProgressUpdate videoTimeNotReady;
// }
//
...
//    final void Function(MediaPlayer player) onPrepared;
//
//   /// Callback to be invoked when playback of a media source has completed.
//    final void Function(MediaPlayer player) onCompletion;
//
//   /// Callback to be invoked when there has been an error during an asynchronous
//   /// operation.
//    final void Function(MediaPlayer player, int what, int extra) onError;
//
...
//
//   /// Adds a callback.
//    final void Function(VideoAdPlayerCallback callback) addCallback;
//
//   /// Loads a video ad hosted at AdMediaInfo.
//    final void Function(AdMediaInfo adMediaInfo, AdPodInfo adPodInfo) loadAd;
//
//   /// Pauses playing the current ad.
//    final void Function(AdMediaInfo adMediaInfo) pauseAd;
//
//   /// Starts or resumes playing the video ad referenced by the AdMediaInfo,
//   /// provided loadAd has already been called for it.
//    final void Function(AdMediaInfo adMediaInfo) playAd;
//
//   /// Cleans up and releases all resources used by the `VideoAdPlayer`.
//    final void Function() release;
//
//   /// Removes a callback.
//    final void Function(VideoAdPlayerCallback callback) removeCallback;
//
//   /// Stops playing the current ad.
//    final void Function(AdMediaInfo adMediaInfo) stopAd;
//
...
//    final void Function(AdsManagerLoadedEvent event) onAdsManagerLoaded;
// }
//
...
//    final void Function(AdErrorEvent event) onAdError;
// }
//
