...
enum AdEventType {
  ...
  /// Fired every time the stream switches from advertising or s to content.
  adPeriodEnded,

  /// Fired every time the stream switches from content to advertising or s.
  adPeriodStarted,
...
abstract class UIViewController extends NSObject {
  ...
  /// Notifies the view controller that its view was added to a view hierarchy.
   void Function(bool animated) viewDidAppear;
...
abstract class IMAAdsManagerDelegate extends NSObject {
  ...
  /// Called when an ad is ready to play.
   final void Function(IMAAdsManager adsManager) didRequestContentPause;

  /// Called when an ad has finished or an error occurred during the playback.
   final void Function(IMAAdsManager adsManager) didRequestContentResume;
}
